...
pixi run -e golden-retriever-perception demo-gemini-pointing-flow
pixi run -e golden-retriever-perception demo-owl-sam-segmentation-flow
```
...
pixi run -e golden-retriever-perception python -m examples.advanced.real_perception.gemini_pointing_flow --backend gemini_api --query "point to the red block"
pixi run -e golden-retriever-perception python -m examples.advanced.real_perception.owl_sam_segmentation_flow --backend owl_sam_local --labels "red block,blue block"
```

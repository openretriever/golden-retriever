...
Run against robosuite after installing the simulator requirements:
    ...
    def init(self) -> None:
        ...
        if self.mode == "robosuite":
            try:
                ...
                raise RuntimeError(
                    "robosuite is not installed. Install the simulator requirements "
                    "from `examples/advanced/robocasa/requirements-simulator.txt` "
                    "or run "

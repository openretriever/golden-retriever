...
- `robocasa_drawer/`: a Panda opens a drawer, puts a seasoning jar away inside it, and shuts it; mock-safe lane plus optional MuJoCo/RoboCasa lanes and a browser viewer.
...
- `robocasa_drawer/README.md`: the put-the-seasoning-away routine, the passive-slide-joint claim, and the optional asset setup.

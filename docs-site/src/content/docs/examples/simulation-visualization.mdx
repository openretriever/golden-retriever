...
in [`examples/advanced/robocasa_replay/README.md`](https://github.com/openretriever/golden-retriever/tree/main/examples/advanced/robocasa_replay).
...
Source: `examples/advanced/robosuite_lift/app.py`,
`examples/advanced/robocasa_replay/app.py`, and

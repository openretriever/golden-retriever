...
4. Source tree mixes code, generated outputs, model assets, and vendored payloads.
   ...
   - Remaining tracked generated/asset candidates include experiment result figures and benchmark artifacts; decide whether each should ship as docs evidence, release artifacts, or be regenerated by scripts.
...
5. Dependencies remain developer-oriented.
   - Direct Git dependencies in optional Pixi features make some heavy environments fragile.

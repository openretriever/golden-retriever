...
def align_exact(
    ...
    *,
    ...
    """Join events only when event_time_ns is exactly equal."""
...
def align_latest_before(
    ...
    *,
    ...
    """Join each right event with the latest left event at/before right event time."""
    if max_delta_ns < 0:
...
def align_window(
    ...
    *,
    ...
    """Join each right event with nearest left event within +/- window_ns."""
    if window_ns < 0:
...
def join_with_policy(
    ...
    *,
    ...
    """Dispatch join behavior based on policy mode."""

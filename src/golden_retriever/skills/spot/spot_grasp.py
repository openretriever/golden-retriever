...
from retriever.robots.spot.spot_perception_structs import RGBDImageWithContext
from retriever.robots.spot.spot_utils import get_robot_state
from retriever.skills.spot.spot_hand_move import close_gripper
...
def grasp_at_pixel(
    ...
    if grasp_rot is not None:
        ...
        grasp.grasp_params.grasp_params_frame_name = (
            VISION_FRAME_NAME  # pylint: disable=no-member
        )
        ...
        # Turn into a proto.
        constraint = (
            grasp.grasp_params.allowable_orientation.add()

...
from cliport.models.streams.two_stream_attention import (
    TwoStreamAttention,
    TwoStreamAttentionLat,
)
from cliport.models.streams.two_stream_transport import (
    TwoStreamTransport,
...
class TransporterAgent(torch.nn.Module):
    ...
    def train_new(self):
        ...
        #     frame[i] = torch.from_numpy(frame[i]).to(self.device_type)
        ...
        return step, total_loss.item(), [loss0.item(), loss1.item()]
    ...
    def save(self, models_dir):
        ...
        print(f"Save {model_path} model at {self.total_steps} iterations.")

...
from lepp.lang_goal_noFourier import LEPPAgentWoFourier
...
from lepp.transporter_lang_goal import TransporterAgent
from lepp.transporter_lang_goal_steer import TransporterAgentSteer

names = {
    ################################
    ### LEPP ###
    "LEPP": LEPPAgent,
    "LEPPWoPlaceFourier": LEPPAgentWoFourier,
    "Transporter": TransporterAgent,
    "TransporterAgentSteer": TransporterAgentSteer,
    ### CLIPort ###

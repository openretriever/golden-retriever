...
from cliport.tasks.assembling_kits import AssemblingKits, AssemblingKitsEasy
from cliport.tasks.assembling_kits_seq import (
    AssemblingKitsSeqFull,
    AssemblingKitsSeqSeenColors,
    AssemblingKitsSeqUnseenColors,
)
from cliport.tasks.block_insertion import (
    BlockInsertion,
    BlockInsertionEasy,
...
from cliport.tasks.packing_boxes_pairs import (
    PackingBoxesPairsFull,
    PackingBoxesPairsSeenColors,
    PackingBoxesPairsUnseenColors,
)
from cliport.tasks.packing_google_objects import (
...
from cliport.tasks.separating_piles import (
    SeparatingPilesFull,
...
from cliport.tasks.towers_of_hanoi_seq import (

    ...
    def reset(self, env):
        ...
        self.lang_goals.append(
            self.lang_template.format(
                blocks="the green, blue and purple blocks", row="bottom"
            )
        )
        ...
        self.lang_goals.append(
            self.lang_template.format(
                blocks="the yellow and orange blocks", row="middle"
            )
        )
        ...
        self.lang_goals.append(
            self.lang_template.format(blocks="the red block", row="top")
        )

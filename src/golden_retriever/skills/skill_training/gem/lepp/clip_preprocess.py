...
class CLIP_processor:
    ...
    def get_clip_feature_from_text_and_image(
        self, img, lang_goal, img_goal, kernel_size=40, stride=20, normalization=True
    ):
        ...
        return clip_feature_text, clip_feature_image, combined_feature, text_emb
...
def get_and_save_clip_features(
    ...
    processor = CLIP_processor(clip_feature_type)

...
This folder contains useful utils for Spot and GraphNav maps to used by the repo. Most of the utils is currently adapted from BDAI [`predicators`](https://github.com/bdaiinstitute/predicators).

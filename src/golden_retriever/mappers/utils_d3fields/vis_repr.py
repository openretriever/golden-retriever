...
if scene == "mug":
    data_path = (
        "src/models/mapping/utils_d3fields/data/2023-09-15-13-21-56-171587"  # mug
    )
    pca_path = "src/models/mapping/utils_d3fields/pca_model/mug.pkl"
    query_texts = ["mug"]
    query_thresholds = [0.3]
elif scene == "fork":
    data_path = (
        "src/models/mapping/utils_d3fields/data/2023-09-15-14-15-01-238216"  # fork
    )
    pca_path = "src/models/mapping/utils_d3fields/pca_model/fork.pkl"
    query_texts = ["fork"]
    query_thresholds = [0.25]
elif scene == "shoe":
    data_path = (
        "src/models/mapping/utils_d3fields/data/2023-09-11-14-15-50-607452"  # shoe
    )
    pca_path = "src/models/mapping/utils_d3fields/pca_model/shoe.pkl"
    query_texts = ["shoe"]
...
cam_matrix = np.array(
    [
        [0.87490918, -0.24637599, 0.41693261, 0.63666708],
...
# create feature mesh
feature_mesh = fusion.create_descriptor_mesh(
    vertices, triangles, out, {"pca": pca}, mask_out_bg=True
)

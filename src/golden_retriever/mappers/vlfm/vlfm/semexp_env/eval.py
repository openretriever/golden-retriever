...
from ..semexp_env.semexp_policy import SemExpITMPolicyV2, SemExpITMPolicyV3
from ..utils.img_utils import reorient_rescale_map, resize_images
from ..utils.log_saver import is_evaluated, log_episode
from ..utils.visualization import add_text_to_image
...
def main() -> None:
    ...
    policy_kwargs = dict(
        ...
        pointnav_policy_path="src/mappers/vlfm/data/pointnav_weights.pth",
...
def generate_video(
    ...
    filename = f"epid={episode_id:03d}-scid={scene_id}-succ={success}-spl={spl:.2f}-dtg={dtg:.2f}-target={goal_name}.mp4"

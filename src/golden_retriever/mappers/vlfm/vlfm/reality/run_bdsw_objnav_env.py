...
from ..policy.reality_policies import RealityConfig, RealityITMPolicyV2
from ..reality.objectnav_env import ObjectNavEnv
from ..reality.robots.bdsw_robot import BDSWRobot


@hydra.main(
    version_base=None,
    config_path="../../../../config/mappers/vlfm",
    config_name="experiments/reality",
)

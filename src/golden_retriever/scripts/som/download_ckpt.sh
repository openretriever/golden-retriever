...
mv swinl_only_sam_many2many.pth ../../src/utils/som/downloaddata
mv seem_focall_v1.pt ../../src/utils/som/downloaddata
mv sam_vit_h_4b8939.pth ../../src/utils/som/downloaddata
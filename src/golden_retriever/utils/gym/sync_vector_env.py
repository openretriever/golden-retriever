...
class SyncVectorEnv(VectorEnv):
    ...
    def seed(self, seeds=None):
        ...
        for env, seed in zip(self.envs, seeds, strict=False):
            env.seed(seed)
    ...
    def step_wait(self):
        observations, infos = [], []
        for i, (env, action) in enumerate(zip(self.envs, self._actions, strict=False)):
    ...
    def set_attr(self, name: str, values):
        ...
        for env, value in zip(self.envs, values, strict=False):
